RailsAdmin.config do |config|
  ...
  config.audit_with :paper_trail, 'Organization', 'PaperTrail::Version' # PaperTrail >= 3.0.0
  config.audit_with :paper_trail, 'Location', 'PaperTrail::Version' # PaperTrail >= 3.0.0
  config.audit_with :paper_trail, 'Offer', 'PaperTrail::Version' # PaperTrail >= 3.0.0

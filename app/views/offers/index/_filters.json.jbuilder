...
json.target_audience(
  TargetAudienceFilter.identifiers_for_section(@current_section)
) do |identifier|
  json.identifier identifier
  json.display_name t(".target_audience.#{identifier}")
end

json.exclusive_gender(
  TargetAudienceFiltersOffer::STAMP_FIRST_PART_GENDERS
) do |identifier|
  json.identifier identifier
...
json.residency_status(
  TargetAudienceFiltersOffer::RESIDENCY_STATUSES
) do |identifier|
  json.identifier identifier

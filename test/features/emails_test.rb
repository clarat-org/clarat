...
feature 'emails#offers_index' do
  ...
  scenario 'offers_index for E-Mail with offers in section gets shown' do
    offer1 = FactoryBot.create :offer, :family_section, :approved, name: 'baz'
    offer2 = FactoryBot.create :offer, :refugee_section, :approved, name: 'fuz'
    offer3 = FactoryBot.create :offer, :family_section, :approved, name: 'foo'
  ...
  scenario 'offers_index for E-Mail without offers in section gets shown' do
    @fam_offer1 = FactoryBot.create(:offer,
                                    :family_section,
                                    :approved,
                                    name: 'baz')
